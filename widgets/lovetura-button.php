...
class LoveButton extends Widget_Base {
  ...
  protected function _content_template() {
    ...
    <div class="elementor-button-wrapper">
        <a class="elementor-button elementor-size-{{ settings.size }}" {{{ view.getRenderAttributeString( 'title', 'button' ) }}} href="#" data-token="ae04a56c597bb8e70b4d4b429df086a5" onclick="mjOpenPopin(event, this)">{{{ settings.title }}}</a>
    </div>
    <?php
  }
}